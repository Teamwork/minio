This is the same as the "official" minio/minio, reset to commit
e1f64141a275329be787766eea72c711aaa2a504.

The reason for this is that later versions are broken. Specifically, the fix
https://github.com/minio/minio/pull/3612 is broken.
